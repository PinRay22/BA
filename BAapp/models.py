...
class OffensiveStats(models.Model):
    OSID =models.AutoField('進攻端戰術統計表編號', primary_key=True )
    P1 = models.CharField('背號', max_length=50)
    P2 = models.CharField('背號', max_length=50)
    P3 = models.CharField('背號', max_length=50)
    P4 = models.CharField('背號', max_length=50)
    P5 = models.CharField('背號', max_length=50)
    OffensiveSystem = models.CharField('我方進攻系統', max_length=100)
    Shooter = models.CharField('出手者', max_length=50)
    IsVacant = models.BooleanField('是否空檔', default=False)
    IsScored = models.BooleanField('是否得分', default=False)
    Remarks = models.TextField('備註', blank=True)
    O1 = models.CharField('背號', max_length=50)
    O2 = models.CharField('背號', max_length=50)
    O3 = models.CharField('背號', max_length=50)
    O4 = models.CharField('背號', max_length=50)
    O5 = models.CharField('背號', max_length=50)
    DefensiveSystem = models.CharField('對方防守系統', max_length=100)
    Opponent_Remarks = models.TextField('對方備註', blank=True)

class DefensiveStats(models.Model):
    DSID =models.AutoField('防守端戰術統計表編號', primary_key=True )  ##############
    P1 = models.CharField('背號', max_length=50)
    P2 = models.CharField('背號', max_length=50)
    P3 = models.CharField('背號', max_length=50)
    P4 = models.CharField('背號', max_length=50)
    P5 = models.CharField('背號', max_length=50)
    DefensiveSystem = models.CharField('我方防守系統', max_length=100)
    Opponent_Remarks = models.TextField('備註', blank=True)
    O1 = models.CharField('背號', max_length=50)
    O2 = models.CharField('背號', max_length=50)
    O3 = models.CharField('背號', max_length=50)
    O4 = models.CharField('背號', max_length=50)
    O5 = models.CharField('背號', max_length=50)
    OffensiveSystem = models.CharField('對方進攻系統', max_length=100)
    Shooter = models.CharField('出手者', max_length=50)
    IsVacant = models.BooleanField('是否空檔', default=False)
    IsScored = models.BooleanField('是否得分', default=False)
    Remarks = models.TextField('備註', blank=True)
